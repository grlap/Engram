...
| Reserved-temp diagnosis across the other nonterminal phases | T2/T4/T9/T10, C2 | `upgrade_review_v7_status_nonterminal_foreign_temps_refuse_before_effects` | Explicit Prepared, intent-only Prepared and Activated fixtures crossed with three foreign temporary kinds; collect all nine independent results before asserting |
