...
# Keep SQLite-heavy tests deterministic on hosts with a small inherited file
# descriptor limit, while still bounding libtest concurrency.
...
require_positive_integer ENGRAM_TEST_FD_LIMIT "$target_fd_limit"
require_positive_integer ENGRAM_TEST_THREADS "$test_threads"
