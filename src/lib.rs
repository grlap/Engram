...
pub use domain::{
    ...
    ForgetProjectMemoryRequest, GateEvidenceRecord, HostPathPolicy, IssuedTurnGrant,
    ...
    SessionPhase, TaskAdmissionEpoch, TaskDelta, TaskId, TurnBeginDecision, TurnBeginReceipt,
    ...
    TurnGrantSupersession, TurnGrantSupersessionReason, TurnIntent, TurnNextIntent, TurnPurpose,
...
pub use work_service::{
    ...
    WorkEvidenceSummary, WorkFocusView, WorkHandoffInput, WorkHandoffResult, WorkInspectView,
    WorkNextQuery, WorkNextSection, WorkNextView, WorkObligationGuidance, WorkObligationPage,
